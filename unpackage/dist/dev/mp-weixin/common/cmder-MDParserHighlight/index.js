...
/* harmony import */ var _index_vue_vue_type_template_id_705353c5___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=705353c5& */ 196);
...
var _markedMin = _interopRequireDefault(__webpack_require__(/*! ./assets/marked.min.js */ 200));
var _index = _interopRequireDefault(__webpack_require__(/*! ./highlight.js/lib/index.js */ 201));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var Parser = function Parser() {Promise.all(/*! require.ensure | common/cmder-MDParserHighlight/parser/parser */[__webpack_require__.e("common/vendor"), __webpack_require__.e("common/cmder-MDParserHighlight/parser/parser")]).then((function () {return resolve(__webpack_require__(/*! ./parser/parser.vue */ 212));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { props: { resource: { type: String, default: "**请输入markdown内容**" } }, components: { Parser: Parser },
  data: function data() {
    return {
      tagStyle: {
        // 代码块
